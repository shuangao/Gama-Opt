...
\subfloat[Comparision with MULTIpLE. MULTIpLE sets transfer the prior knowledge] {\includegraphics[scale=0.4]{fig/A2A_gama.eps}\label{fig:awa-b}}
...
\subsection{mixed}
In real applications, extreme situation where the knowledge is highly related/unrelated, is rare. 
\begin{figure*}
  \centering
